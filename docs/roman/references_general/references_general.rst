...
+                                             +--------------------------------------------------------------+
|                                             | :ref:`INVERSELINEARITY <inverselinearity_reffile>`           |
+                                             +--------------------------------------------------------------+
|                                             | :ref:`INTEGRALNONLINEARITY <integralnonlinearity_reffile>`   |
+---------------------------------------------+--------------------------------------------------------------+
...
+------------------------------------------------------------+---------------------------------------------+
| :ref:`INTEGRALNONLINEARITY <integralnonlinearity_reffile>` | :ref:`linearity <linearity_step>`           |
+------------------------------------------------------------+---------------------------------------------+
| :ref:`INVERSELINEARITY <inverselinearity_reffile>`         | :ref:`linearity <linearity_step>`           |
+------------------------------------------------------------+---------------------------------------------+

...
def create_image():
    l2im = rdm.WfiImageModel.make_default()
...
def create_distortion():
    distortions = [rdm.DistortionRefModel.make_default()]

    model = create_image()
    dist = rdm.DistortionRefModel.make_default()

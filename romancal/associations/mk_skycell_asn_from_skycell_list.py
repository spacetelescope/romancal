...
def mk_skycell_asn_from_skycell_list(filelist, release_product, optical_element):
    """
    ...
    for skycell_index in unique_skycell_indices:
        ...
        asn_file_name = f"r{program_id}_{release_product}_v{member_list[0][1:20]}_{skycell.name}_{optical_element}"

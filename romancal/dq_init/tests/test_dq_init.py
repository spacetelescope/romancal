...
def test_dq_im(xstart, ystart, xsize, ysize, ngroups, instrument, exp_type):
    ...
    ref_data.meta.xstart = xstart
    ref_data.meta.xsize = xsize
    ref_data.meta.ystart = ystart
    ref_data.meta.ysize = ysize
...
def test_groupdq():
    ...
    # create raw input data for step
    dm_ramp = make_rawramp(instrument, ngroups, ysize, xsize, ystart, xstart)
...
def make_rawramp(instrument, ngroups, ysize, xsize, ystart, xstart, exp_type=None):
    ...
    dm_ramp.meta.xstart = xstart
    dm_ramp.meta.xsize = xsize
    dm_ramp.meta.ystart = ystart
    dm_ramp.meta.ysize = ysize

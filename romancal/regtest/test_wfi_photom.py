...
@pytest.mark.bigdata
def test_zero_point_photometric_calibration(rtdata, ignore_asdf_paths):
    # DMS139 Test: Testing application of photometric correction using CRDS selected photom file.
    ...
    #  zero point photometry calibrated in the WFI filter used for the exposure.
    step.log.info('DMS139 MSG: Testing zero point photometry calibrated image data. '
                  'Success is creation of a Level 2 image file with CRDS selected '
                  'photom file applied.')

    step.log.info(f'DMS139 MSG: Image data file: {rtdata.input.rsplit("/", 1)[1]}')
    ...
    step.log.info('DMS139 MSG: Running photometric conversion step.'
    ...
    step.log.info(f'DMS139 MSG: Photom step recorded as complete? : '
                  f'{photom_out.meta.cal_step.photom == "COMPLETE"}')
    assert photom_out.meta.cal_step.photom == "COMPLETE"

    step.log.info('DMS139 MSG: Photom megajansky conversion calculated? : ' +
    ...
    step.log.info('DMS139 MSG: Photom microjanskys conversion calculated? : ' +
    ...
    step.log.info('DMS139 MSG: Pixel area in steradians calculated? : ' +
    ...
    step.log.info('DMS139 MSG: Pixel area in square arcseconds calculated? : ' +
    ...
    step.log.info('DMS139 MSG: Photom megajansky conversion uncertainty calculated? : ' +
    ...
    step.log.info(f'DMS139 MSG: Was the proper absolute photometry calibrated image data produced?'

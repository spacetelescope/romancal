...
def test_level2_image_processing_pipeline(rtdata, ignore_asdf_paths):
    ...
    pipeline.log.info(
        "DMS86 MSG: Testing completion of data quality"
    ...
    pipeline.log.info(
        "DMS86 MSG: Testing completion of linearity correction"
    ...
    pipeline.log.info(
        "DMS86 MSG: Testing completion of saturation detection "
        "in Level 2 image output......."
    ...
    pipeline.log.info(
        "DMS-129 MSG: Testing completion of WCS assignment in"
    ...
    pipeline.log.info(
        "DMS-129 MSG: Testing that geometric distortion information is available in"
        "Level 2 image output......."
    ...
    pipeline.log.info(
        "DMS-129 MSG: Testing that distortion correction was applied to"
        "Level 2 image output......."
        + passfail(
    ...
    pipeline.log.info(
        "DMS88 MSG: Testing existence of total exposure time "
...
def test_level2_grism_processing_pipeline(rtdata, ignore_asdf_paths):
    ...
    pipeline.log.info(
        "DMS90 MSG: Testing completion of wcs assignment in"
    ...
    pipeline.log.info(
        "DMS90 MSG: Testing expected skip of flat fielding in"
        "Level 2 spectroscopic output......."
    ...
    pipeline.log.info(
        "DMS90 MSG: Testing completion of dark correction in"
        "Level 2 spectroscopic output......."
        + passfail(model.meta.cal_step.dark == "COMPLETE")
    )
    assert model.meta.cal_step.dark == "COMPLETE"
    ...
    pipeline.log.info(
        "DMS90 MSG: Testing completion of data quality "
    ...
    pipeline.log.info(
        "DMS90 MSG: Testing completion of jump detection in"
        "Level 2 spectroscopic output......."
        + passfail(model.meta.cal_step.jump == "COMPLETE")
    )
    assert model.meta.cal_step.jump == "COMPLETE"
    ...
    pipeline.log.info(
        "DMS90 MSG: Testing completion of linearity correction "
    ...
    pipeline.log.info(
        "DMS90 MSG: Testing completion of ramp fitting in"
        "Level 2 spectroscopic output......."
        + passfail(model.meta.cal_step.ramp_fit == "COMPLETE")
    )
    assert model.meta.cal_step.ramp_fit == "COMPLETE"
    ...
    pipeline.log.info(
        "DMS90 MSG: Testing completion of saturation detection "
        "in Level 2 spectroscopic output......."
        + passfail(model.meta.cal_step.saturation == "COMPLETE")
    )
    assert model.meta.cal_step.saturation == "COMPLETE"
    ...
    pipeline.log.info(
        "DMS91 MSG: Testing existence of data quality array (dq)"
        " in Level 2 spectroscopic output......."
        + passfail("dq" in model.keys())
    )
    assert "dq" in model.keys()
    pipeline.log.info(
        "DMS91 MSG: Testing existence of general error "
        "array (err) in Level 2 spectroscopic output......."
        + passfail("err" in model.keys())
    )
    assert "err" in model.keys()
    pipeline.log.info(
        "DMS91 MSG: Testing existence of Poisson noise variance "
        "array (var_poisson) in Level 2 spectroscopic output.."
        + passfail("var_poisson" in model.keys())
    )
    assert "var_poisson" in model.keys()
    pipeline.log.info(
        "DMS91 MSG: Testing existence of read noise variance "
    ...
    # DMS88 total exposure time test
    pipeline.log.info(
        "DMS88 MSG: Testing existence of total exposure "

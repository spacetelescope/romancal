...
class SkyCell:
    ...
    def from_name(cls, name: str, skymap: "SkyMap" = None) -> "SkyCell":
        """Retrieve a skycell from the skymap by its name (see handbook [1] for explanation).
...
class SkyCells:
    ...
    def from_names(cls, names: list[str], skymap: "SkyMap" = None) -> "SkyCells":
        """Retrieve skycells from the loaded skymap by name (see handbook [1] for explanation).
...
class SkyMap:
    """Abstract representation of the skymap, comprising of 4058 overlapping rectangular

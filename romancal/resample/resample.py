...
from ._exptime_resampler import ExptimeResampler
from ._l3_wcs import assign_l3_wcs
from ._meta_blender import MetaBlender
from ._utils import compute_var_sky
...
class ResampleData(Resample):
    ...
    def __init__(
        ...
        wcs_kwargs : dict, None
            ...
            `romancal.resample.make_output_wcs`

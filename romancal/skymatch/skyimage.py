...
class NDArrayMappedAccessor(DataAccessor):
    ...
    def get_data(self):
        self._tmp.seek(0)
        return pickle.load(self._tmp)

    def set_data(self, data):
        data = np.asanyarray(data)
        self._data_shape = data.shape
        self._tmp.seek(0)
        pickle.dump(data, self._tmp)
    ...
    * mask associated image data indicating "good" (1) data.
    ...
    def __init__(self, image, wcs_fwd, wcs_inv, pix_area=1.0, convf=1.0,
        ...
        skystat : callable, None, optional
            ...
            :py:class:`~romancal.skymatch.skystatistics.SkyStats` object
    ...
    def set_builtin_skystat(self, skystat='median', lower=None, upper=None,
        ...
        See :py:class:`~romancal.skymatch.skystatistics.SkyStats` for the

...
def match(images, skymethod="global+match", match_down=True, subtract=False):
    ...
    images : list of SkyImage or SkyGroup
        A list of :py:class:`~romancal.skymatch.skyimage.SkyImage` or
        :py:class:`~romancal.skymatch.skyimage.SkyGroup` objects.
    ...
    TypeError
        ...
        :py:class:`~romancal.skymatch.skyimage.SkyImage` and/or
        :py:class:`~romancal.skymatch.skyimage.SkyGroup` objects.
    ...
    **Limitations and Discussions:**
      ...
      :py:class:`~romancal.skymatch.skystatistics.SkyStats` and these
      parameter names may differ from the parameters of the actual `skystat`
      object passed to initializer of the
      :py:class:`~romancal.skymatch.skyimage.SkyImage`.
    ...
    log.debug(
        f"Total number of images to be sky-subtracted and/or matched: {nimages:d}"
    )
